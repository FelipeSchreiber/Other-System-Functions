...
#ifndef MLDL_UML_APPROVE_REGISTRATION_REQUEST_H
#define MLDL_UML_APPROVE_REGISTRATION_REQUEST_H "@(#)mldlUmlApproveRegistrationRequest.h $Revision$"
...
/*
	mldlUmlErrorType
	MldlUmlApproveRegistrationRequest(mldlUmlConfigurationsType *, char *, char *)
	...
	Description:
	This function allows a qualified user of the system to approve the entrace of an user who requested entry to
	the system.
*/

mldlUmlErrorType
MldlUmlApproveRegistrationRequest(mldlUmlConfigurationOptionsType *, char *, char *);
